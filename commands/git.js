...
const exampleEmbed = new EmbedBuilder()
	...
	.addFields(
		...
		{ name: '$ git clone [url]', value:'Baixa um porjeto e seu histórico de versão inteiro', inline: true },
		{ name: '$ git stash', value: 'Armazena temporariamente todos os arquivos monitorados modificados', inline: true },
        { name: '\u200B', value: '\u200B' },
        { name: '$ git status', value: 'Revisa edições e crie uma transação de commit', inline: true},
        ...
        { name: '\u200B', value: '\u200B' },
        { name: '$ git branch', value: 'Lista todas as branchs locais no repositório atual', inline: true},
		...
		{ name: '$ git push [alias] [branch]', value: 'Envia todos os commtis da branch local para o GitHub', inline: true },
